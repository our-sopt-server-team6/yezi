...
/-- 아무 값이나 INSERT 해보기 --/
INSERT INTO post  VALUES ('Luke', 'The Great Gatsby','blah blah','1900/09/19'); 
...
SELECT * FROM post JOIN user WHERE userIdx = '4';

/-- postIdx가 2인 데이터 날짜 현재로 수정하기 --/
UPDATE post SET createAt = '2020/5/28' WHERE postIdx = '2';
